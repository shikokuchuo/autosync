...
R sync server for [Automerge](https://automerge.org/) CRDT documents. Implements the automerge-repo WebSocket protocol, enabling R to serve as a synchronization hub for Automerge clients (in R, JavaScript, Rust, etc.).
